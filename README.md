...
For example, the following command is issued to retrain resnext50_32x4d with the train and test folders inside car_data folder copied into the same directory:
